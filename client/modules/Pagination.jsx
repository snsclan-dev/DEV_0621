...
export const Pagination_Link = ({url, paging}) => {
    const linkBlock = [];
    ...
    return (
        <div className="layout_paging">
            ...
            <div className="page_left">
                ...
                {paging.linkPrev > 1 && <Link href={`${url}/${paging.linkPreve}`}><li className="page">이전</li></Link>}
            </div>
...
export const Pagination_Click = ({paging, page}) => {
    const linkBlock = [];
    for (let i = paging.linkStart; i <= paging.linkEnd; i++) {
        linkBlock.push(i);
    }
